#' Compute and plot empirical codon usage indexes.
#'
#' For a specified sample this function computes an empirical codon usage index
#' based on the frequency of in-frame P-sites along the coding sequence (or one
#' of the other two ribosome sites relative to them and falling in the CDS). It
...
#'   may not include one or more columns among \emph{p_site_codon},
#'   \emph{a_site_codon} and \emph{e_site_codon}. These columns reports the
#'   three nucleotides covered by the P-site, A-site and E-site respectively and
#'   can be previously generated by the \code{\link{psite_info}} function. If
#'   not already present, the column of interest specified by \code{site} is
...
#'   interest.
#' @param site Either "psite, "asite" or "esite". This parameter specifies which
#'   of the three ribosome sites (P-site, A-site and E-site, rispectively) must
#'   be used for computing the empirical codon usage indexes. Default is
#'   "psite".
...
#'   if one or more columns among \emph{p_site_codon}, \emph{a_site_codon} and
#'   \emph{e_site_codon} have been previously generated by
...
#'   required to normalize the data, even if one or more columns among
#'   \emph{p_site_codon}, \emph{a_site_codon} and \emph{e_site_codon} have been
#'   previously generated by \code{\link{psite_info}}. Default is NULL.
