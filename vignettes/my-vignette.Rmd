...
coverage_dt <- data.table(transcript = rep("ENSMUST00000000001.4", 6),
...
```
```{r, out.width = '275px', fig.retina = NULL, echo = FALSE, fig.align = "center"}
